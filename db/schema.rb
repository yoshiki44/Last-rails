...
ActiveRecord::Schema.define(version: 20_210_516_054_806) do
  ...
  create_table 'spree_option_type_prototypes', id: :integer, charset: 'utf8mb3',
                                               force: :cascade do |t|
  ...
  create_table 'spree_option_values_variants', id: :integer, charset: 'utf8mb3',
                                               force: :cascade do |t|
    t.integer 'variant_id'
  ...
  create_table 'spree_payment_capture_events', id: :integer, charset: 'utf8mb3',
                                               force: :cascade do |t|
  ...
  create_table 'spree_product_option_types', id: :integer, charset: 'utf8mb3',
                                             force: :cascade do |t|
    t.integer 'position'
  ...
  create_table 'spree_product_promotion_rules', id: :integer, charset: 'utf8mb3',
                                                force: :cascade do |t|
    t.integer 'product_id'
  ...
  create_table 'spree_promotion_action_line_items', id: :integer, charset: 'utf8mb3',
                                                    force: :cascade do |t|
  ...
  create_table 'spree_promotion_categories', id: :integer, charset: 'utf8mb3',
                                             force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
  ...
  create_table 'spree_promotion_code_batches', id: :integer, charset: 'utf8mb3',
                                               force: :cascade do |t|
  ...
  create_table 'spree_promotion_rule_taxons', id: :integer, charset: 'utf8mb3',
                                              force: :cascade do |t|
    t.integer 'taxon_id'
    t.integer 'promotion_rule_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_promotion_rules_users', id: :integer, charset: 'utf8mb3',
                                              force: :cascade do |t|
    t.integer 'user_id'
    t.integer 'promotion_rule_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_reimbursement_credits', id: :integer, charset: 'utf8mb3',
                                              force: :cascade do |t|
    t.decimal 'amount', precision: 10, scale: 2, default: '0.0', null: false
    t.integer 'reimbursement_id'
  ...
  create_table 'spree_return_authorizations', id: :integer, charset: 'utf8mb3',
                                              force: :cascade do |t|
    t.string 'number'
    t.string 'state'
    t.integer 'order_id'
  ...
  create_table 'spree_roles_users', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.index %w(user_id role_id), name: 'index_spree_roles_users_on_user_id_and_role_id',
                                 unique: true
  ...
  create_table 'spree_shipping_method_categories', id: :integer, charset: 'utf8mb3',
                                                   force: :cascade do |t|
  ...
  create_table 'spree_shipping_method_zones', id: :integer, charset: 'utf8mb3',
                                              force: :cascade do |t|
    t.integer 'shipping_method_id'
    t.integer 'zone_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_shipping_rates', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6
    t.integer 'tax_rate_id'
    t.index %w(shipment_id shipping_method_id), name: 'spree_shipping_rates_join_index',
                                                unique: true
  end
  ...
  create_table 'spree_store_credit_categories', id: :integer, charset: 'utf8mb3',
                                                force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
  ...
  create_table 'spree_store_payment_methods', id: :integer, charset: 'utf8mb3',
                                              force: :cascade do |t|
  ...
  create_table 'spree_tax_rate_tax_categories', id: :integer, charset: 'utf8mb3',
                                                force: :cascade do |t|
  ...
  create_table 'spree_user_addresses', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.index %w(user_id address_id), name: 'index_spree_user_addresses_on_user_id_and_address_id',
                                    unique: true
    t.index ['user_id'], name: 'index_spree_user_addresses_on_user_id'
  end

  create_table 'spree_user_stock_locations', id: :integer, charset: 'utf8mb3',
                                             force: :cascade do |t|
    t.integer 'user_id'
    t.integer 'stock_location_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_users', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.index ['reset_password_token'], name: 'index_spree_users_on_reset_password_token_solidus_auth_devise',
                                      unique: true
    t.index ['spree_api_key'], name: 'index_spree_users_on_spree_api_key'
  end

  create_table 'spree_variant_property_rule_conditions', id: :integer, charset: 'utf8mb3',
                                                         force: :cascade do |t|
    t.integer 'option_value_id'
  ...
  create_table 'spree_variant_property_rule_values', id: :integer, charset: 'utf8mb3',
                                                     force: :cascade do |t|
    t.text 'value'
    t.integer 'position', default: 0
    t.integer 'property_id'
  ...
  create_table 'spree_variant_property_rules', id: :integer, charset: 'utf8mb3',
                                               force: :cascade do |t|
    t.integer 'product_id'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  ...
  create_table 'spree_wallet_payment_sources', id: :integer, charset: 'utf8mb3',
                                               force: :cascade do |t|
    t.integer 'user_id', null: false
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w(user_id payment_source_id payment_source_type),
            name: 'index_spree_wallet_payment_sources_on_source_and_user', unique: true
